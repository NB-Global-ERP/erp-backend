...
public class CourseCompletionStatusController {
    ...
    @PostMapping
    public ResponseEntity<CreateResponse> create(@RequestBody @Valid CourseCompletionStatusRequest request) {
        var id = courseCompletionStatusService.create(request);
